...
import { useAnimalsData } from '@/app/hooks/useAnimalsData';
...
export default async function AnimalsTable({
  ...
  const { animalsData, loading, error, fetchAnimalData} = useAnimalsData()

  useEffect(() => {
    fetchAnimalData();
  }, [fetchAnimalData, animalsData, loading, error]);
